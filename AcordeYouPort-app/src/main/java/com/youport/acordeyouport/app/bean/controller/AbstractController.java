...
import com.youport.acordeyouport.app.facade.LazyEntityDataModel;
...
public abstract class AbstractController<T> implements Serializable {
    ...
    /**
     * Session scoped managed bean that stores information about the parameter
     * de configurations
     */
    @Inject
    protected ConfigurationMasterParameter configurationMasterParameter;
    ...
    public void save(ActionEvent event) {
        String msg = ResourceBundle.getBundle("/YouPortBundle").getString(itemClass.getSimpleName() + "Updated");
    ...
    public void saveNew(ActionEvent event) {
        String msg = ResourceBundle.getBundle("/YouPortBundle").getString(itemClass.getSimpleName() + "Created");
    ...
    public void delete(ActionEvent event) {
        String msg = ResourceBundle.getBundle("/YouPortBundle").getString(itemClass.getSimpleName() + "Deleted");
    ...
    public ConfigurationMasterParameter getConfigurationMasterParameter() {
        return configurationMasterParameter;
    }

    public void setConfigurationMasterParameter(ConfigurationMasterParameter configurationMasterParameter) {
        this.configurationMasterParameter = configurationMasterParameter;
    }

    public String navigateToDashboard() {
        String index = null;
        switch (UserType.valueOf(getUserManagedBean().getType())) {
